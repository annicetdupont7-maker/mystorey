...
Dernière vérification : 2026-09-21

## État de la base de production (lu le 2026-09-21)

La production ne contient que 9 tables : `profiles`, `stores`, `store_themes`, `products`,
...
appliquées. L'application fonctionne sans elles (fonctionnalités masquées), mais :
...
## Migrations à appliquer (dans cet ordre, strictement additives, rejouables)
...
- Appliquer les deux migrations ci-dessus.
